...
<a class = "hover-link" href="customerDashboard.jsp" style="text-decoration: none;">
...
<div class="container"> 
<h1><span style="color: #fdfefe;">Welcome To The Banking Online DashBoard, User <%= custId %>!</span></h1>
